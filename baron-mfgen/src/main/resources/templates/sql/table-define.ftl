...
INSERT INTO TBFDDS (TFDSID, TBMSID, FLDNAM, FLDALS, TITLE, LANGUG, DTATYP, LENGTH, SCLLEN, DFTVAL, REQURD, REMARK) VALUES (${column.ctfdsid}, ${table.tbmsid}, '${column.name}', '${column.jlabel}', '${column.clabel}', 'zh-CN', '${column.type.nativeType}', ${column.type.length}, ${column.type.scale}, ${column.defineSqlValue}, '<#if column.nullable>Y<#else>N</#if>', '${column.remark}');
INSERT INTO TBFDDS (TFDSID, TBMSID, FLDNAM, FLDALS, TITLE, LANGUG, DTATYP, LENGTH, SCLLEN, DFTVAL, REQURD, REMARK) VALUES (${column.etfdsid}, ${table.tbmsid}, '${column.name}', '${column.jlabel}', '${column.elabel}', 'en-US', '${column.type.nativeType}', ${column.type.length}, ${column.type.scale}, ${column.defineSqlValue}, '<#if column.nullable>Y<#else>N</#if>', '${column.remark}');
