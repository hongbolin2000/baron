...
<#list table.columns as column>
    ${column.sqlName} ${column.mySQLType}<#if column.value??> DEFAULT ${column.value}</#if><#if column.nullable> NOT NULL</#if><#if column.identity> AUTO_INCREMENT</#if> COMMENT '${column.clabel}',
</#list>
